@echo off
echo ===================================
echo Lancement du service d'albums
echo ===================================
...
echo Port configuré : %ALBUM_SERVICE_PORT%
if not "%ALBUM_SERVICE_PORT%"=="8083" (
    echo Attention : Le port n'est pas 8083 comme attendu !
    echo Port actuel : %ALBUM_SERVICE_PORT%
)

set SERVER_PORT=%ALBUM_SERVICE_PORT%
...
if errorlevel 1 (
    echo Erreur lors de l'installation du service d'albums
    exit /b 1
)
